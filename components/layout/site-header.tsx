...
export default function SiteHeader({ profile }: SiteHeaderProps) {
  return (
    <header className="sticky top-4 z-40 mb-10 rounded-full border border-border/80 bg-surface/70 px-4 py-3 shadow-[0_10px_40px_rgba(0,0,0,0.25)] backdrop-blur-xl">
